...
public:
    ...
    virtual void ActionBegin(unsigned __int32* tempPixels, int x_click, int y_click, int len, int hei, int get_x, int get_y, int show_rect_x, int show_rect_y, int scale, int size, unsigned __int32 pixelColor) = 0;
    virtual void ActionUpdate(unsigned __int32* tempPixels, int x_start, int y_start, int x_finish, int y_finish, int len, int hei, int get_x, int get_y, int show_rect_x, int show_rect_y, int scale, int size, unsigned __int32 pixelColor) = 0;
    virtual void ActionEnd(unsigned __int32* tempPixels, int x_start, int y_start, int x_finish, int y_finish, int len, int hei, int get_x, int get_y, int show_rect_x, int show_rect_y, int scale, int size, unsigned __int32 pixelColor) = 0;
};
...
namespace plugin {
    ...
    public:
        ...
        virtual void Clear(color_t color_t) = 0;
        virtual void Present() = 0;
